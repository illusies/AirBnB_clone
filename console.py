...
class HBNBCommand(cmd.Cmd):
    ...
    def default(self, arg):
        """ A function that defines the default behaviour for the 
            cmd module when an input is invalid
    ...
    def do_EOF(self, argv):
        """A function that executes the EOF menu command to exit the program
    ...
    def do_quit(self, argv):
        """A function that executes the Quit menu command to exit the program
    ...
    def do_create(self, argv):
        """ A function that executes the Create menu command to create a new instance
            of the BaseModel class, save it (to a JSON file) and print the id
    ...
    def do_show(self, argv):
        """ A function that executes the Show menu command and prints the string 
    ...
    def do_all(self, argv):
        """ A function that executes the All menu command and prints all string 
            representation of all instances based on or not on the class name
    ...
    def do_destroy(self, argv):
        """ A function that execuites the Destroy menu command and deletes a class 
            instance based on the name and given id and saves the changes to the 
            JSON file
    ...
    def do_update(self, argv):
        """ A function that executes the Update menu command and updates an instance 
            based on the class name and id by adding or updating attribute and saves 
            the changes the JSON file
    ...
    def do_count(self, arg):
        """ A function that executes the Count menu command and retrieve the number of 
